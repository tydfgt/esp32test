    ...
    public static EPaperDisplay[] getDisplays()
    {
        if (array == null)
        {
            array = new EPaperDisplay[]
            {
                ...
                new EPaperDisplay(960,680,0, "13.3 inch e-Paper (K)"),      // 45
                new EPaperDisplay(800,480,0, "4.26 inch e-Paper"),          // 46
                new EPaperDisplay(128,296,1, "2.9 inch e-Paper (B) V4"),    // 47
                new EPaperDisplay(960,680,1, "13.3 inch e-Paper (B)")       // 48
            };
        }
        return array;
    }
